            ...
            <div class="col-md-12 mt-5">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-success" data-toggle="modal" data-target="#provider"> <i class="fas fa-plus"></i></button>
                </div>
              </div>
              <!-- /.card-header -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="providerLabel">Novo Fornecedor</h5>
